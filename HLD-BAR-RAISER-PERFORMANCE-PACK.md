...
Use the **strip at the top** of each `NN-hld-*.md` in the room; use **this file** as the printable / deep reference. In the interview: **speak out loud**, **pause**, simulate **interruptions** in mocks—content prep is already Strong Hire level.

---

## 1. Live interview opening (say naturally)
